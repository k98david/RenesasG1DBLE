...
;             1.c -oDefaultBuild -_msgoff -qwvjl3 -dCFG_FULLEMB,CFG_CON=1,CFG_E
...
; In-file   : ..\..\..\..\..\src\arch\rl78\fw_update_count1.c
; Asm-file  : DefaultBuild\fw_update_count1.asm
; Para-file : 
...
$DGS	AUX_FIL, fw_update_count1.c
$DGS	MOD_NAM, fw_update_count1,	00H,	0FFFEH,	00H,	077H,	00H,	00H
...
$DGS	SEC_NAM, MAIN_CN1,	U,	U,	00H,	078H,	00H,	00H
...
$DGS	GLV_SYM, _fw_update_count_1,	U,	U,	0D00DH,	026H,	00H,	00H

	PUBLIC	_fw_update_count_1
...
MAIN_CN1	CSEG	PAGE64KP
_fw_update_count_1:	DW	00H	; 0
