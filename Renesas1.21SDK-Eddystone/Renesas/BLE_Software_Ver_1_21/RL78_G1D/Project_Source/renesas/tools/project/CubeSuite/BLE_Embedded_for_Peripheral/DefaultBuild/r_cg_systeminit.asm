...
;             vice\RL78\Devicefile cg_src\r_cg_systeminit.c -oDefaultBuild -_ms
;             goff -qwvjl3 -icg_src -zps -mm -mi0 -aDefaultBuild -no -rc -xDefa
;             ultBuild -g2
; In-file   : cg_src\r_cg_systeminit.c
...
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H
$DGS	GLV_SYM, _R_WDT_Create,	U,	U,	01H,	02H,	01H,	02H
$DGS	AUX_FUN, 00H,		U,	U,	00H,	01H,	00H
...
;	ite\BLE_Embedded_for_Peripheral\cg_src\r_cg_systeminit.c
;
