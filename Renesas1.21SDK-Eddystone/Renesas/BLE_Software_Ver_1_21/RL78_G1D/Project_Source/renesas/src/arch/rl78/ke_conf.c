...
#include "..\sample_app\rble_sample_app_peripheral.h"
#else
#include "..\sample_app\rble_sample_app_central.h"
#endif
...
_TSK_DESC const struct ke_task_desc TASK_DESC_ent[] =
{
    ...
    #endif
    DESGN(TASK_USR_1)  { APP_State_Handler, &APP_Default_Handler, APP_State, APP_STATE_MAX, APP_IDX_MAX  },
